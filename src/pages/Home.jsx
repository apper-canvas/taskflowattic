          ...
          >
            ...
            <div className="mt-12">
              <h2 className="text-xl font-bold mb-6 flex items-center">
                <span className="mr-2">TaskFlow Features</span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 auto-rows-fr">
                {[
                  ...
                  { icon: 'bell', title: 'Notifications', description: 'Get reminded about upcoming deadlines' },
                  { icon: 'bar-chart-2', title: 'Productivity Reports', description: 'Analyze your productivity patterns' },
                  { icon: 'users', title: 'Team Collaboration', description: 'Share and assign tasks with teammates' },
                  { icon: 'layout-dashboard', title: 'Custom Dashboard', description: 'Personalize your task view' }
                ].map((feature, index) => {
